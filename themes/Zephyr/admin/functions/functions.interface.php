...
function optionsframework_add_admin() {
	...
	$of_page = add_submenu_page( 'us-home', US_THEMENAME, __( 'Theme Options', 'us' ), 'edit_theme_options', 'us-theme-options', 'optionsframework_options_page' );
...
function of_ajax_callback()
{
	...
	elseif($save_type == 'restore_options')
	{
		...
		if ( ! us_save_styles($smof_data)) { die(0); }
	...
	elseif ($save_type == 'reset')
	{
		...
		if ( ! us_save_styles($options_machine->Defaults)) { die(0); }
