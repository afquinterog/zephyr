...
if ( function_exists( 'wp_get_theme' ) ) {
	...
	if ( is_child_theme() ) {
		$theme_obj = wp_get_theme( $theme_obj->get( 'Template' ) );
	}
	...
	$theme_data = wp_get_theme( $us_template_directory . '/style.css' );
...
define( 'ADMIN_PATH', $us_template_directory . '/admin/' );
define( 'ADMIN_DIR', $us_template_directory_uri . '/admin/' );
define( 'LAYOUT_PATH', ADMIN_PATH . 'layouts/' );
define( 'US_THEMENAME', $theme_name );
